  ...
  <section className="absolute top-0 w-full -z-10 bg-black text-white">
    ...
    <div className="container mx-auto relative">
      ...
      <div className="text-center pt-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 pt-6">
          <div className="bg-transparent rounded-xl border border-purple-400 hover:border-purple-800 hover:scale-105 transition-all cursor-pointer p-8 flex items-center justify-center text-7xl">
            <img src="image/postman-icon-svgrepo-com (1).svg"  className="w-20 h-20" />
          </div>
          <div className="bg-transparent rounded-xl border border-purple-400 hover:border-purple-800 hover:scale-105 transition-all cursor-pointer p-8 flex items-center justify-center text-7xl">
              <img src="image/firebase-svgrepo-com (1).svg"  className="w-20 h-20"/>
          </div>
