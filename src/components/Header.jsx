      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-12 text-xl text-white font-semibold">
            <Link to="/" className="cursor-pointer duration-200 hover:border-b-4 pb-2 border-purple-400">
              <i className="ri-home-7-line"></i> Home
            </Link>
            <Link to="/about" className="cursor-pointer duration-200 hover:border-b-4 pb-2 border-purple-400">
              <i className="ri-user-line"></i> About
            </Link>
            <Link to="/projects" className="cursor-pointer duration-200 hover:border-b-4 pb-2 border-purple-400">
              <i className="ri-broadcast-line"></i> Project
            </Link>
            <Link to="/resume" className="cursor-pointer duration-200 hover:border-b-4 pb-2 border-purple-400">
              <i className="ri-booklet-line"></i> Resume
            </Link>
            <Link to="/blog" className="cursor-pointer duration-200 hover:border-b-4 pb-2 border-purple-400">
              <i className="ri-news-line"></i> Blogs
            </Link>
            <Link to="/contact" className="cursor-pointer duration-200 hover:border-b-4 pb-2 border-purple-400">
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="md:hidden mt-4 bg-[#000000aa] rounded p-6 text-white flex flex-col gap-4 text-lg font-semibold">
